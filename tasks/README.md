...
| 16 | systemd units + timer + due-ness engine + catch-up + **live install** | 10, 12, 14, 15, 07a, 20, 28 | **codex** | claude | **WIP** (capture and transport policy merged #118/#120; full-sync due planner awaiting review; runtime scheduler and live acceptance remain owed) |
